                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <a href="restaurant-detail.html" class="grid_item">
                                <figure>
                                    ...
                                    <img src="assets/img/restaurant_1.jpg" class="img-fluid" alt=""/>
                                    <div class="info">
                                        <h3>Da Alfredo</h3>
                                    </div>
                                </figure>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <a href="restaurant-detail.html" class="grid_item">
                                <figure>
                                    <div class="score"><strong>7.9</strong></div>
                                    <img src="assets/img/restaurant_2.jpg" class="img-fluid" alt=""/>
                                    <div class="info">
                                        <h3>Slow Food</h3>
                                    </div>
                                </figure>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <a href="restaurant-detail.html" class="grid_item">
                                <figure>
                                    ...
                                    <img src="assets/img/restaurant_3.jpg" class="img-fluid" alt=""/>
                                    <div class="info">
                                        <h3>Bella Napoli</h3>
                                    </div>
                                </figure>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <a href="restaurant-detail.html" class="grid_item">
                                <figure>
                                    ...
                                    <img src="assets/img/restaurant_4.jpg" class="img-fluid" alt=""/>
                                    <div class="info">
                                        <h3>Marcus</h3>
                                    </div>
                                </figure>
